let rituals = {
    ...
    mana: {
        ...
        req: ["b5_2"],
        gain() { return game.points.gte("ee10") ? game.points.max(10).slog(10).pow(5).div(243).mul(upgEffect("k1_3")).mul(upgEffect("e1_1")).mul(game.upgrades.pow17?upgEffect("pow17"):1).floor().mul(window.supporterCodeInput ?2:1) : EN(0); },
